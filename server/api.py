...
def mount_knowledge_routes(app: FastAPI):
    ...
    from server.knowledge_base.kb_doc_api import (list_files, upload_docs, upload_docs_use_path, delete_docs,
    ...
    app.post("/knowledge_base/upload_docs_use_path",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="给出要处理的文件路径到知识库，并/或进行向量化"
             )(upload_docs_use_path)
...
def mount_filename_summary_routes(app: FastAPI):
    from server.knowledge_base.kb_summary_api import (summary_file_to_vector_store,
